...
Write-Host "==================================="
Write-Host "Windows 10 Installation Script"
Write-Host "==================================="
Write-Host ""
...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "C:/SharedVirtualBoxFolder", "/host_shared"
  config.vm.provision "shell", privileged: true, powershell_args: "-ExecutionPolicy Bypass", inline: <<-SHELL
      $ChromeInstaller = "C:/host_shared/ChromeSetup.exe"
...
Write-Host "Thank you for using the Vagrant installer script!"
pause
